...
namespace bloom {
	...
	void Game::Init(Uint32 init_flags,
	...
	void Game::set_color(const SDL_Color & color) {
		color_ = color;
		SDL_SetRenderDrawColor(renderer_, color_.a, color_.g, color_.b, color_.a);
	}

	void Game::set_color(Uint8 r, Uint8 g, Uint8 b, Uint8 a) {
		color_ = { r, g, b, a };
		SDL_SetRenderDrawColor(renderer_, color_.a, color_.g, color_.b, color_.a);
	}

	SDL_Color Game::color() {
		return color_;
	}

	void Game::color(Uint8 & r, Uint8 & g, Uint8 & b, Uint8 & a) {
